...
import type { IconDefinition } from '@lotus-design/icons-svg/lib/types';

export interface LotusIconProps extends IconBaseProps {
  twoToneColor?: TwoToneColor;
}

export interface IconComponentProps extends LotusIconProps {
  icon: IconDefinition;
}
